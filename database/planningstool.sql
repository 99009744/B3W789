...
--
-- Host: localhost
-- Gegenereerd op: 29 apr 2020 om 18:19
-- Serverversie: 8.0.18
-- PHP-versie: 7.3.11
...
CREATE TABLE `planning` (
  ...
  `time` time NOT NULL,
  `explainer` varchar(255) NOT NULL,
...
INSERT INTO `planning` (`id`, `gameid`, `time`, `explainer`, `players`) VALUES
(1, 2, '04:44:00', 'UPDATE ME', 'qwe'),
(2, 10, '16:16:00', 'daas', 'd p o p'),
(7, 9, '01:01:00', 'mitchell', 'iedereen'),
(13, 3, '01:01:00', 'aa', '1');
